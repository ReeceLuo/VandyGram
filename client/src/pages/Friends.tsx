    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm">
          {dataArray.map((tab) => (
            <button
              onClick={() => setCurrTab(tab.label)}
              key={tab.label}
              className={`flex items-center px-3 py-1 text-sm rounded-md transition-color ${
                currTab === tab.label
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    {
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-gradient-to-r from-amber-300 to-yellow-600 hover:from-yellow-500 hover:to-yellow-700 active:scale-95 transition text-white cursor-pointer"
                      >
                        View Profile
                      </button>
                    }
